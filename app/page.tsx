...
const SpecuroLogo = ({ size = 24, bracketOpacity = "0.3" }) => (
  <svg width={size} height={size} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {/* 修正后的四个角：全部朝内包裹 */}
    <path d="M12 2H2V12" stroke="black" strokeWidth="2.5" /> {/* 左上 */}
    <path d="M52 2H62V12" stroke="black" strokeWidth="2.5" opacity={bracketOpacity} /> {/* 右上 */}
    <path d="M62 52V62H52" stroke="black" strokeWidth="2.5" /> {/* 右下 */}
    <path d="M2 52V62H12" stroke="black" strokeWidth="2.5" opacity={bracketOpacity} /> {/* 左下修正版 */}
    ...
    <text 
      ...
      style={{ 
        ...
        filter: 'drop-shadow(0px 0.5px 0.5px rgba(255,255,255,0.3))' 
      }}
    >
      S
    </text>
    ...
    return (
      <div className="h-screen w-full flex flex-col items-center justify-center bg-white text-black p-10 font-sans">
        ...
        <div className="w-full max-w-xs space-y-4">
          ...
          <button onClick={handleAuth} className="w-full bg-black text-white py-4 text-[10px] font-black tracking-widest uppercase hover:opacity-80 transition-all">
              ...
              return (
                <div key={item.id} className="group relative">
                  ...
                  <div className="space-y-4 text-left text-black">
                    ...
                    <div><label className="block mb-1">Technical Specs</label><p className="text-[11px] font-medium font-mono leading-relaxed">{item.dimensions}</p></div>
